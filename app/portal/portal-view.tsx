    ...
    <div className="space-y-6">
      ...
      <div className="grid md:grid-cols-4 gap-4">
        ...
        <StatCard
          ...
          color={data.customer.balance > 0 ? '#8B0000' : '#2c2c2c'}
        ...
        <StatCard
          ...
          color={totalOverdue > 0 ? '#8B0000' : '#2c2c2c'}
        ...
        <div className="bg-red-50 border border-red-200 rounded-lg p-4 flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-red-600 mt-1">
              Please contact Kimbercrust Bakery to arrange payment. Ph: (03) 9000 0000
            </p>
          </div>
        </div>
      )}
    ...
    <div className="bg-white rounded-lg shadow-md p-6">
      ...
      {sorted.length === 0 ? (
        <div className="text-center py-12">
          ...
          <p className="text-gray-400 text-sm mt-2">Contact Kimbercrust Bakery to set up a standing order</p>
        </div>
      ) : (
                    ...
                    <table className="w-full text-sm">
                      ...
                      <tfoot className="bg-gray-50">
                        <tr>
                          ...
                          <td className="py-2 px-4 font-bold text-right" style={{ color: '#2c2c2c' }}>
                            {fmt(total)}
                          </td>
                        </tr>
                      </tfoot>
                    ...
                    <table className="w-full text-sm">
                      ...
                      <tfoot className="bg-gray-50">
                        <tr>
                          ...
                          <td className="py-2 px-3 font-bold text-right" style={{ color: '#2c2c2c' }}>
                            {fmt(order.total_amount)}
                          </td>
                        </tr>
                      </tfoot>
                      ...
                      <table className="w-full text-sm">
                        ...
                        <tfoot className="bg-gray-50 border-t">
                          ...
                          <tr>
                            ...
                            <td className="py-2 px-3 text-right font-bold" style={{ color: '#2c2c2c' }}>
                              {fmt(inv.total_amount)}
                            </td>
                          </tr>
                        </tfoot>
          ...
          <table className="w-full text-sm">
            ...
            <tfoot className="border-t">
              <tr className="font-bold">
                ...
                <td className="py-2 px-3 text-right" style={{ color: arBalance.total_due > 0 ? '#8B0000' : '#2c2c2c' }}>
