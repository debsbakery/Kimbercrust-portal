      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="max-w-md bg-white rounded-lg shadow-lg p-8 text-center">
          ...
          <div className="flex gap-3 justify-center">
            ...
            <Link href="/" className="px-6 py-2 text-white rounded-md" style={{ backgroundColor: "#2c2c2c" }}>
              Back to Home
            </Link>
          </div>
        </div>
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="max-w-md bg-white rounded-lg shadow-lg p-8 text-center">
          ...
          <Link href="/" className="inline-block px-6 py-2 text-white rounded-md" style={{ backgroundColor: "#2c2c2c" }}>
            Back to Home
          </Link>
        </div>
      </div>
