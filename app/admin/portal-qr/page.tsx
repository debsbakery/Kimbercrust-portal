...
const PORTAL_URL = 'https://kimbercrust-portal.vercel.app/portal'
const APPLY_URL  = 'https://kimbercrust-portal.vercel.app/register'
...
/* ─────────────────────────────────────────────────────
   CARD 1 — Existing customer portal access
───────────────────────────────────────────────────── */
function PortalCard() {
  return (
    <div
    ...
    >
      ...
      <div className="px-6 py-5 text-white text-center" style={{ backgroundColor: '#2c2c2c' }}>
        ...
        <p className="text-xs opacity-75 mt-1">Kununurra WA</p>
      </div>
      ...
      <div className="px-6 py-5 flex flex-col items-center gap-4">
        ...
        <div className="w-full text-center">
          ...
          <p className="text-xs font-mono font-bold" style={{ color: '#8B0000' }}>
            kimbercrust-portal.vercel.app/portal
          </p>
        </div>
      ...
      <div className="px-6 py-3 text-center" style={{ backgroundColor: '#f8f4f0' }}>
        <p className="text-xs text-gray-500">
          Questions? Call{' '}
          <span className="font-semibold text-gray-700">08 9169 1664</span>
        </p>
      </div>
    </div>
  )
...
/* ─────────────────────────────────────────────────────
   CARD 2 — New customer self-onboarding
───────────────────────────────────────────────────── */
function ApplyCard() {
  return (
    <div
    ...
    >
      ...
      <div className="px-6 py-5 flex flex-col items-center gap-4">
        ...
        <div className="w-full text-center">
          <p className="text-xs text-gray-400 mb-0.5">Or visit</p>
          <p className="text-xs font-mono font-bold" style={{ color: '#8B0000' }}>
            kimbercrust-portal.vercel.app/register
          </p>
        </div>
