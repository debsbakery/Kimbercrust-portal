      ...
      {selectedCustomerId && orders.length > 0 && (
        <>
          ...
          <div className="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-xl text-sm text-blue-700">
            ...
            <p>Ask them to check their <strong>Junk/Spam</strong> or <strong>Other</strong> inbox tab, and add <strong>orders@kimbercrust.com</strong> to their contacts. Use the <strong>PDF</strong> button above to manually send via Outlook if needed.</p>
          </div>
        </>
      )}
