  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid gap-4 md:grid-cols-3 lg:grid-cols-6 mb-8">
        <div className="bg-white rounded-lg shadow-md p-4 border-l-4" style={{ borderColor: "#2c2c2c" }}>
        ...
        <div className="bg-white rounded-lg shadow-md p-4 border-l-4" style={{ borderColor: "#8B0000" }}>
          <p className="text-xs text-gray-600">Over 90 Days</p>
          <p className="text-xl font-bold" style={{ color: "#8B0000" }}>
                    ...
                    <TableRow key={customer.customer_id} className={hasBalance ? "" : "opacity-50"}>
                      ...
                      <TableCell className="text-center">
                        <Link
                          ...
                          style={{ 
                            backgroundColor: hasBalance ? "#2c2c2c" : "#9CA3AF",
                            color: "white" 
                          }}
                        >
                          View Ledger
