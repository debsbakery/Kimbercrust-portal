...
<style>
  ...
  .invoice-table th { background: #2c2c2c; color: white; padding: 12px 10px; text-align: left; }
  .totals { margin-top: 20px; text-align: right; }
  .totals-row { padding: 5px 0; font-size: 15px; }
  .total-grand { font-size: 20px; color: #2c2c2c; border-top: 2px solid #2c2c2c; padding-top: 10px; margin-top: 5px; }
  .btn { display: inline-block; padding: 12px 25px; background: #2c2c2c; color: white; text-decoration: none; border-radius: 6px; margin: 5px; font-weight: bold; }
...
<div class="card">
  ...
  <div style="background:#f8f9fa;padding:10px;border-left:4px solid #2c2c2c;margin-bottom:15px;">
