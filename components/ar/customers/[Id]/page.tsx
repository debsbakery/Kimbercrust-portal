  ...
  return (
    <div className="container mx-auto p-6">
      ...
      <div className="flex justify-between items-start mb-6">
        <div>
          <h1 className="text-3xl font-bold">{customer.business_name || customer.contact_name}</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div>
          <PaymentForm
            ...
            customerName={customer.business_name || customer.contact_name || customer.email}
